...
$form.addEventListener('submit', function () {
  ...
  if (data.editing === null) {
    ...
    data.entries[data.editing.entryID] = {
      title: $form.elements.title.value,
      photoUrl: $form.elements.photo.value,
      notes: $form.elements.notes.value,
...
$uList.addEventListener('click', function () {
  var $editEntry = event.target.closest('li').getAttribute('data-entry-id');
  $editEntry = parseInt($editEntry);
  data.editing = data.entries[$editEntry];
...
function renderEntry(entry) {
  ...
  $pencil.setAttribute('onclick', 'viewSwap(\'entry-form\')');
